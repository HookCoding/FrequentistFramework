...
class BlackCheck(TierCheck):
    check_id = "black"
    tier = 2
    requirement = "Black passes on the authoritative Tier 2 targets and modular checker."
    ...
    def run(self, context: CheckContext) -> CheckResult:
        ...
        return CheckResult(
            ...
            "Black passed" if code == 0 else f"Black exited {code}",
            details,
