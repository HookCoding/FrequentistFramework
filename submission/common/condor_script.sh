...
wrapperfunction
    ...
    #datafile=/afs/cern.ch/work/l/lbazzano/tla/FrequentistFramework/run/Run3_TLA150_1000_fourPar_finebinned_scale29.55.root
    #datafile=/afs/cern.ch/work/l/lbazzano/tla/FrequentistFramework/run/Run3_TLA150_1000_fivePar_finebinned_scale29.55.root
    #datafile=/eos/user/l/lbazzano/TLA/FreqFrameOutputs/run_${pars}Par/Run3_TLA150_1000_${pars}Par_finebinned_scale29.55.root

    # bkg only // SS
    #datafile=/eos/user/l/lbazzano/TLA/FreqFrameOutputs/run_${pars_B}Par/Run3_TLA${rangelow}_${rangehigh}_${pars_B}Par_finebinned_scale29.55.root
    #datafile=/eos/user/l/lbazzano/TLA/FreqFrameOutputs/minimumStudy/${rangelow}_run_${pars_B}Par/Run3_TLA${rangelow}_${rangehigh}_${pars_B}Par_finebinned_scale29.55.root
    datafile=/eos/user/l/lbazzano/TLA/FreqFrameOutputs/run_${rangelow}_${rangehigh}_${pars_B}Par/Run3_TLA${rangelow}_${rangehigh}_${pars_B}Par_finebinned_scale29.55.root
    outputfile=${folder}/FitResult_anaFit_${pars_SB}Par_pseudodata${p}_mean${sigmean}_width${sigwidth}.root

    # signal injected
    #datafile=/eos/user/l/lbazzano/TLA/FreqFrameOutputs/run_${pars_B}Par/injected/Run3_TLA${rangelow}_${rangehigh}_${pars_B}Par_finebinned_scale29.55_mean${si_mean}_width${si_width}_amp${si_amp}.root
