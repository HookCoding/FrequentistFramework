...
def main(args):
    ...
    parser.add_option('--outfile', dest='outfile', type=str, default='extractionGraphs_signalInjection.root', help='Output file name')
    ...
    for j,sigmean in enumerate(sigmeans):
        ...
        for i,sigwidth in enumerate(sigwidths):
            ...
            for k,sigamp in enumerate(sigamps):
                ...
                #/eos/...pseudodatafits_fourPar_injected_mean650_width5_amp0/fit_fourPar_mass200_width9_pseudodata12_injected_mean650_width5_amp0/FitParameters_anaFit_Par_pseudodata_injected_mean650_width5_amp0_fit_mean200_width9.00.root
                k=0
